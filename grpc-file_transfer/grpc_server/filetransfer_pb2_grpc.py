...
class FileTransferStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendFile = channel.stream_unary(
                ...
                response_deserializer=filetransfer__pb2.FileResponse.FromString,
...
def add_FileTransferServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendFile': grpc.stream_unary_rpc_method_handler(
                    ...
                    response_serializer=filetransfer__pb2.FileResponse.SerializeToString,
            ),
    }
...
class FileTransfer(object):
    ...
    def SendFile(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            filetransfer__pb2.FileResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
